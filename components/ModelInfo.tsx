    ...
    <div className={`rounded-xl shadow-sm border overflow-hidden ${bgCard}`}>
      ...
      <div className="p-4 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-1 flex flex-col h-full">
            <div className={`group relative w-full flex-1 min-h-[160px] rounded-xl border-2 border-dashed transition-all duration-300 flex flex-col items-center justify-center overflow-hidden cursor-pointer mt-6 md:mt-0 ${
                darkMode 
